...
TMDB_API_KEY = "c3443ed2f96cd615e3badf6b68c8a689"  # তোমার TMDB API KEY
        ...
        if data.get("results"):
            ...
            if backdrop_path:
                ...
                await message.reply_photo(
                    photo=image_url,
                    caption=f"🎬 **Welcome!**\n\nHere's a random movie: **{title}**"
                )
            else:
                await message.reply_text("Couldn't find a backdrop image.")
        else:
            await message.reply_text("Couldn't fetch movie data from TMDB.")

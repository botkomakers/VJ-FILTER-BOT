...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002530980008 -1002596384181').split()]  # For Multiple Id Use One Space Between Each.

...
Sᴜᴘᴇʀ-ꜰᴀsᴛ | Sᴍᴀʀᴛ Rᴇᴘʟʏ | ᴇᴀʀɴ Mᴏɴᴇʏ ᴀꜱ ʏᴏᴜ ɢʀᴏᴡ!

➤ Add Me to Your Group & Unlock:
▸  Aᴜᴛᴏ Mᴏᴠɪᴇ/Sᴇʀɪᴇꜱ ꜰɪʟᴛᴇʀɪɴɢ  
▸  Pʀᴇᴍɪᴜᴍ-Lᴇᴠᴇʟ Dᴏᴡɴʟᴏᴀᴅꜱ ꜰᴏʀ Usᴇʀꜱ  
▸  Cᴜsᴛᴏᴍ ʀᴇᴘʟɪᴇꜱ, ᴄᴀᴘᴛɪᴏɴꜱ & ᴛʜᴜᴍʙɴᴀɪʟꜱ  
▸  Eᴀʀɴ Uɴʟɪᴍɪᴛᴇᴅ Mᴏɴᴇʏ ᴡɪᴛʜ ꜰɪʟᴇ ꜱʜᴀʀɪɴɢ! 💸

Hᴏᴡ Iᴛ Wᴏʀᴋs:  
Just ᴛʏᴘᴇ ᴛʜᴇ ᴍᴏᴠɪᴇ/ꜱᴇʀɪᴇꜱ ɴᴀᴍᴇ... I’ll ɢᴇɴɪᴜꜱʟʏ ꜰɪɴᴅ & ꜱᴇɴᴅ ɪᴛ ɪɴ ᴀ ᴄʟɪᴄᴋ! 🪄

Tʀᴜꜱᴛᴇᴅ ʙʏ 1000+ Gʀᴏᴜᴘꜱ | 24x7 Aᴄᴛɪᴠᴇ | Pʀᴇᴍɪᴜᴍ Sᴜᴘᴘᴏʀᴛ</b>"""
...
👨‍💻 Cᴏᴍᴍᴀɴᴅ : /clone</b>"""
    ...
    SUBSCRIPTION_TXT = """
<b>✨ ɢᴇᴛ 𝗣𝗥𝗘𝗠𝗜𝗨𝗠 𝗙𝗢𝗥 𝗙𝗥𝗘𝗘 – ʀᴇғᴇʀ ᴀɴᴅ ᴇᴀʀɴ! ✨

ᴜɴʟᴏᴄᴋ {} ᴅᴀʏꜱ ᴏғ 𝗣𝗥𝗘𝗠𝗜𝗨𝗠 𝗔𝗖𝗖𝗘𝗦𝗦  
ᴊᴜꜱᴛ ʙʏ ꜱʜᴀʀɪɴɢ ʏᴏᴜʀ ʀᴇғᴇʀʀᴀʟ ʟɪɴᴋ!

➤ ꜱʜᴀʀᴇ ᴡɪᴛʜ 𝘍ʀɪᴇɴᴅꜱ • 𝘍ᴀᴍɪʟʏ • 𝘎ʀᴏᴜᴘꜱ • 𝘊ʜᴀɴɴᴇʟꜱ  
➤ ᴀꜱ ꜱᴏᴏɴ ᴀꜱ {} ᴜɴɪǫᴜᴇ ᴜꜱᴇʀꜱ ꜱᴛᴀʀᴛ ᴛʜᴇ ʙᴏᴛ ᴠɪᴀ ʏᴏᴜʀ ʟɪɴᴋ...  
ʏᴏᴜ’ʟʟ ɢᴇᴛ 𝗣𝗥𝗘𝗠𝗜𝗨𝗠 𝗔𝗨𝗧𝗢𝗠𝗔𝗧𝗜𝗖𝗔𝗟𝗟𝗬!  

🎁 ʏᴏᴜʀ ʀᴇғᴇʀʀᴀʟ ʟɪɴᴋ:  
🔗 https://telegram.me/{}?start=VJ-{}

Need More Benefits?  
➤ 𝗨𝗽𝗴𝗿𝗮𝗱𝗲 𝘁𝗼 𝗣𝗮𝗶𝗱 𝗣𝗹𝗮𝗻 – /plan</b>"""

    MANUELFILTER_TXT = """ʜᴇʟᴘ: <b>ꜰɪʟᴛᴇʀꜱ</b>
- ✨ 𝗔ᴜᴛᴏ ꜰɪʟᴛᴇʀ ꜱʏꜱᴛᴇᴍ ✨

ꜰɪʟᴛᴇʀ ɪꜱ ᴀ ᴘᴏᴡᴇʀꜰᴜʟ ꜰᴇᴀᴛᴜʀᴇ ᴛʜᴀᴛ ᴀʟʟᴏᴡꜱ ᴀᴅᴍɪɴꜱ ᴛᴏ ꜱᴇᴛ ᴀᴜᴛᴏ ʀᴇᴘʟɪᴇꜱ ꙰ ʙᴀꜱᴇᴅ ᴏɴ ᴋᴇʏᴡᴏʀᴅꜱ.  
ᴡʜᴇɴ ᴀ ᴜꜱᴇʀ ꜱᴇɴᴅꜱ ᴀ ᴍᴇꜱꜱᴀɢᴇ ᴄᴏɴᴛᴀɪɴɪɴɢ ᴛʜᴀᴛ ᴋᴇʏᴡᴏʀᴅ, ɪ ᴡɪʟʟ ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ʀᴇᴘʟʏ ꜰᴏʀ ʏᴏᴜ.

<b>⚠️ ɴᴏᴛᴇ:</b>
1. ʙᴏᴛ ᴍᴜꜱᴛ ʙᴇ ᴀɴ ᴀᴅᴍɪɴ ɪɴ ᴛʜᴇ ᴄʜᴀᴛ.
2. ᴏɴʟʏ ᴀᴅᴍɪɴꜱ ᴄᴀɴ ᴀᴅᴅ ꜰɪʟᴛᴇʀꜱ.
3. ᴀʟᴇʀᴛ ʙᴜᴛᴛᴏɴꜱ ᴄᴀɴɴᴏᴛ ᴇxᴄᴇᴇᴅ 64 ᴄʜᴀʀᴀᴄᴛᴇʀꜱ.

<b>🛠️ Cᴏᴍᴍᴀɴᴅꜱ & Usᴀɢᴇ:</b>
• <code>/filter</code> – ᴀᴅᴅ ᴀ ɴᴇᴡ ꜰɪʟᴛᴇʀ  
• <code>/filters</code> – ʟɪꜱᴛ ᴀʟʟ ꜰɪʟᴛᴇʀꜱ ɪɴ ᴛʜᴇ ᴄʜᴀᴛ  
• <code>/del</code> – ʀᴇᴍᴏᴠᴇ ᴀ ꜱᴘᴇᴄɪꜰɪᴄ ꜰɪʟᴛᴇʀ  
• <code>/delall</code> – ᴅᴇʟᴇᴛᴇ ᴀʟʟ ꜰɪʟᴛᴇʀꜱ (ᴄʜᴀᴛ ᴏᴡɴᴇʀ ᴏɴʟʏ)

ꜱᴛᴀʀᴛ ᴀᴜᴛᴏᴍᴀᴛɪɴɢ ʏᴏᴜʀ ɢʀᴏᴜᴘ ʟɪᴋᴇ ᴀ ᴘʀᴏ!</code>"""
...
<b>ɴᴏᴛᴇ:</b>
✨ ɪɴʟɪɴᴇ ʙᴜᴛᴛᴏɴ ꜱᴜᴘᴘᴏʀᴛ ✨

ᴛʜɪꜱ ʙᴏᴛ ꜱᴜᴘᴘᴏʀᴛꜱ ʙᴏᴛʜ <b>ᴜʀʟ</b> ᴀɴᴅ <b>ᴀʟᴇʀᴛ</b> ɪɴʟɪɴᴇ ʙᴜᴛᴛᴏɴꜱ.

<b>⚠️ ɴᴏᴛᴇ:</b>
1. Tᴇʟᴇɢʀᴀᴍ ᴅᴏᴇꜱ ɴᴏᴛ ᴀʟʟᴏᴡ ʙᴜᴛᴛᴏɴꜱ ᴡɪᴛʜᴏᴜᴛ ᴀɴʏ ᴄᴏɴᴛᴇɴᴛ. Cᴏɴᴛᴇɴᴛ ɪꜱ ᴍᴀɴᴅᴀᴛᴏʀʏ.
2. Yᴏᴜ ᴄᴀɴ ᴀᴛᴛᴀᴄʜ ʙᴜᴛᴛᴏɴꜱ ᴛᴏ <b>ᴀɴʏ ᴛᴇʟᴇɢʀᴀᴍ ᴍᴇᴅɪᴀ ᴛʏᴘᴇ</b> (ᴛᴇxᴛ, ᴘʜᴏᴛᴏ, ᴠɪᴅᴇᴏ, ᴇᴛᴄ).
3. ᴍᴀᴋᴇ ꜱᴜʀᴇ ʙᴜᴛᴛᴏɴꜱ ᴀʀᴇ <b>ᴘʀᴏᴘᴇʀʟʏ ᴘᴀʀꜱᴇᴅ</b> ᴜꜱɪɴɢ <code>ᴍᴀʀᴋᴅᴏᴡɴ</code> ꜰᴏʀᴍᴀᴛ.
<b>ᴜʀʟ ʙᴜᴛᴛᴏɴꜱ:</b>
...
<b>ɴᴏᴛᴇ: Fɪʟᴇ Iɴᴅᴇx</b>
<b>⚙️ HOW TO ADD YOUR CHANNEL TO THE BOT</b>

<b>1.</b> ᴍᴀᴋᴇ ᴍᴇ ᴛʜᴇ <b>ᴀᴅᴍɪɴ</b> ᴏꜰ ʏᴏᴜʀ ᴄʜᴀɴɴᴇʟ ɪꜰ ɪᴛ'ꜱ ᴘʀɪᴠᴀᴛᴇ.  
<b>2.</b> ᴇɴꜱᴜʀᴇ ʏᴏᴜʀ ᴄʜᴀɴɴᴇʟ <b>ᴅᴏᴇꜱ ɴᴏᴛ ᴄᴏɴᴛᴀɪɴ</b> ᴘᴏʀɴ, ᴄᴀᴍʀɪᴘꜱ, ᴏʀ ꜰᴀᴋᴇ ꜰɪʟᴇꜱ.  
<b>3.</b> ꜰᴏʀᴡᴀʀᴅ ᴛʜᴇ <b>ʟᴀꜱᴛ ᴍᴇꜱꜱᴀɢᴇ</b> ꜰʀᴏᴍ ʏᴏᴜʀ ᴄʜᴀɴɴᴇʟ <b>ᴡɪᴛʜ Qᴜᴏᴛᴇ</b>. ɪ'ʟʟ ᴀᴜᴛᴏ-ᴀᴅᴅ ᴀʟʟ ꜰɪʟᴇꜱ ɪɴ ᴛʜᴀᴛ ᴄʜᴀɴɴᴇʟ ᴛᴏ ᴍʏ ᴅᴀᴛᴀʙᴀꜱᴇ.

<b>🔁 AutoFilter Setup:</b>  
<b>1.</b> Aᴅᴅ ᴛʜᴇ ʙᴏᴛ ᴀꜱ <b>ᴀᴅᴍɪɴ</b> ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ.  
<b>2.</b> Usᴇ <code>/connect</code> ᴛᴏ ʟɪɴᴋ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴡɪᴛʜ ᴛʜᴇ ʙᴏᴛ.  
<b>3.</b> Gᴏ ᴛᴏ ᴛʜᴇ ʙᴏᴛ's ᴘᴍ ᴀɴᴅ ᴜsᴇ <code>/settings</code> ᴛᴏ ᴇɴᴀʙʟᴇ <b>AutoFilter</b> ꜰʀᴏᴍ ᴛʜᴇ ᴍᴇɴᴜ."""

    CONNECTION_TXT = """<b>🧩 HELP: CONNECTIONS</b>

<b>Purpose:</b>  
ᴜꜱᴇᴅ ᴛᴏ ᴄᴏɴɴᴇᴄᴛ ᴛʜᴇ ʙᴏᴛ ᴛᴏ ʏᴏᴜʀ ᴘᴍ ꜰᴏʀ ᴍᴀɴᴀɢɪɴɢ ꜰɪʟᴛᴇʀꜱ — ᴛʜɪꜱ ʜᴇʟᴘꜱ ᴀᴠᴏɪᴅ ꜱᴘᴀᴍᴍɪɴɢ ɢʀᴏᴜᴘꜱ ᴡɪᴛʜ ᴄᴏᴍᴍᴀɴᴅꜱ.

<b>🔔 NOTE:</b>  
1. ᴏɴʟʏ <b>ᴀᴅᴍɪɴꜱ</b> ᴄᴀɴ ᴀᴅᴅ ᴀ ᴄᴏɴɴᴇᴄᴛɪᴏɴ.  
2. ᴛᴏ ᴄᴏɴɴᴇᴄᴛ, ꜱᴇɴᴅ <code>/connect</code> ɪɴ ɢʀᴏᴜᴘ ᴀɴᴅ ᴛʜᴇɴ ᴏᴘᴇɴ ᴍʏ ᴘᴍ.

<b>🛠 COMMANDS & USAGE:</b>  
• <code>/connect</code> – ᴄᴏɴɴᴇᴄᴛ ᴀ ᴘᴀʀᴛɪᴄᴜʟᴀʀ ᴄʜᴀᴛ ᴛᴏ ʏᴏᴜʀ ᴘᴍ  
• <code>/disconnect</code> – ᴅɪꜱᴄᴏɴɴᴇᴄᴛ ꜰʀᴏᴍ ᴀ ᴄᴏɴɴᴇᴄᴛᴇᴅ ᴄʜᴀᴛ  
• <code>/connections</code> – ʟɪꜱᴛ ᴀʟʟ ʏᴏᴜʀ ᴀᴄᴛɪᴠᴇ ᴄᴏɴɴᴇᴄᴛɪᴏɴꜱ"""
...
• /deletefiles - <code>Tᴏ ᴅᴇʟᴇᴛᴇ CᴀᴍRɪᴘ ᴀɴᴅ PʀᴇDVD Fɪʟᴇs ғʀᴏᴍ ᴛʜᴇ ʙᴏᴛ's ᴅᴀᴛᴀʙᴀsᴇ.</code>"""
    ...
    SEC_STATUS_TXT = """<b><b>📊 Bᴏᴛ Sᴛᴀᴛɪꜱᴛɪᴄꜱ</b>
...
★ Fʀᴇᴇ Sᴛᴏʀᴀɢᴇ: <code>{} MB</code></b>"""
    ...
    LOG_TEXT_G = """<b>#NewGroup Aʟᴇʀᴛ</b>

Gʀᴏᴜᴘ: {} (<code>{}</code>)  
Tᴏᴛᴀʟ Mᴇᴍʙᴇʀs: <code>{}</code>  
Aᴅᴅᴇᴅ Bʏ: {}"""

    LOG_TEXT_P = """<b>#NewUser Jᴏɪɴᴇᴅ</b>

ID: <code>{}</code>  
Nᴀᴍᴇ: {}"""

    ALRT_TXT = """<b>ʜᴇʟʟᴏ {},  
ᴛʜɪꜱ ɪꜱɴ'ᴛ ʏᴏᴜʀ ᴍᴏᴠɪᴇ ʀᴇQᴜᴇꜱᴛ.  
ᴘʟᴇᴀꜱᴇ ʀᴇQᴜᴇꜱᴛ ʏᴏᴜʀꜱ ᴘʀᴏᴘᴇʀʟʏ."""

    OLD_ALRT_TXT = """ʜᴇʏ {},
ʏᴏᴜ ᴀʀᴇ ᴜꜱɪɴɢ ᴏɴᴇ ᴏꜰ ᴍʏ ᴏʟᴅ ᴍᴇꜱꜱᴀɢᴇꜱ, 
ᴘʟᴇᴀꜱᴇ ꜱᴇɴᴅ ᴛʜᴇ ʀᴇQᴜᴇꜱᴛ ᴀɢᴀɪɴ."""

    CUDNT_FND = """ɪ ᴄᴏᴜʟᴅɴ'ᴛ ꜰɪɴᴅ ᴀɴʏᴛʜɪɴɢ ʀᴇʟᴀᴛᴇᴅ ᴛᴏ <b>{}</b>.  
ᴅɪᴅ ʏᴏᴜ ᴍᴇᴀɴ ᴀɴʏ ᴏɴᴇ ᴏꜰ ᴛʜᴇꜱᴇ?"""

    I_CUDNT = """<b>ꜱᴏʀʀʏ, ɴᴏ ꜰɪʟᴇꜱ ꜰᴏᴜɴᴅ ꜰᴏʀ ʏᴏᴜʀ ʀᴇQᴜᴇꜱᴛ: <code>{}</code> 😕</b>

<b>➤ ᴘʟᴇᴀꜱᴇ ᴄʜᴇᴄᴋ ᴛʜᴇ ꜱᴘᴇʟʟɪɴɢ ɪɴ ɢᴏᴏɢʟᴇ ᴀɴᴅ ᴛʀʏ ᴀɢᴀɪɴ 😃</b>

<b>🎬 Mᴏᴠɪᴇ RᴇQᴜᴇꜱᴛ Fᴏʀᴍᴀᴛ:</b>  
<code>Uncharted</code> or <code>Uncharted 2022</code> or <code>Uncharted En</code>

<b>📺 Sᴇʀɪᴇꜱ RᴇQᴜᴇꜱᴛ Fᴏʀᴍᴀᴛ:</b>  
<code>Loki S01</code> or <code>Loki S01E04</code> or <code>Lucifer S03E24</code>

<b>🚯 Dᴏɴ’ᴛ ᴜꜱᴇ ➠ ':(!,./)</b>"""

    I_CUD_NT = """<b>ɪ ᴄᴏᴜʟᴅɴ'ᴛ ꜰɪɴᴅ ᴀɴʏ ᴍᴏᴠɪᴇ ʀᴇʟᴀᴛᴇᴅ ᴛᴏ:</b> <code>{}</code>  
<b>➤ ᴘʟᴇᴀꜱᴇ ᴄʜᴇᴄᴋ ᴛʜᴇ ꜱᴘᴇʟʟɪɴɢ ᴏɴ ɢᴏᴏɢʟᴇ ᴏʀ ɪᴍᴅʙ ᴀɴᴅ ᴛʀʏ ᴀɢᴀɪɴ.</b>"""
...
ᴀꜰᴛᴇʀ <b>5 ᴍɪɴᴜᴛᴇꜱ</b>, ᴛʜɪꜱ ᴍᴇꜱꜱᴀɢᴇ ᴡɪʟʟ ʙᴇ <u>ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ᴅᴇʟᴇᴛᴇᴅ</u>.

ɪꜰ ʏᴏᴜ ᴅᴏɴ'ᴛ ꜱᴇᴇ ᴛʜᴇ ʀᴇǫᴜᴇꜱᴛᴇᴅ ᴍᴏᴠɪᴇ / ꜱᴇʀɪᴇꜱ ꜰɪʟᴇ, ᴘʟᴇᴀꜱᴇ ᴄʜᴇᴄᴋ ᴛʜᴇ ɴᴇxᴛ ᴘᴀɢᴇꜱ."""
...
𝗠𝗲𝘀𝘀𝗮𝗴𝗲 <b>: {}</b>"""
    ...
    CAPTION = """<b>📂 ғɪʟᴇɴᴀᴍᴇ :</b> <code>{file_name}</code>
